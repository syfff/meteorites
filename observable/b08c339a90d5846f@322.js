// https://observablehq.com/@d3/icicle@322
...
function _chart(Icicle,flare){return(
Icicle(flare, {
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("chart")).define("chart", ["Icicle","flare"], _chart);
  main.variable(observer("flare")).define("flare", ["FileAttachment"], _flare);
  main.variable(observer()).define(["howto"], _4);
  main.variable(observer("Icicle")).define("Icicle", ["d3"], _Icicle);
